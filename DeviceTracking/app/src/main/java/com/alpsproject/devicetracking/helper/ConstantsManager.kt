...
object ConstantsManager {
    ...
    const val SENSOR_RUNNING_ID = "ID"
    ...
    const val RUNNING_SENSOR_WIFI_ID = RUNNING_SENSOR_WIFI + SENSOR_RUNNING_ID
    const val RUNNING_SENSOR_BLUETOOTH_ID = RUNNING_SENSOR_BLUETOOTH + SENSOR_RUNNING_ID
    const val RUNNING_SENSOR_SCREEN_USAGE_ID = RUNNING_SENSOR_SCREEN_USAGE + SENSOR_RUNNING_ID
